...
def triangulation(uv1,uv2,uv3,cam_param1, cam_param2, cam_param3):
    ...
    if N_available <2:
        ...
        p0,p1 =  projection_img2world_line(uv_list[0],cam_param_list[0],z=-1.0)
        q0,q1 =  projection_img2world_line(uv_list[1],cam_param_list[1],z=-1.0)
        pc,qc = closest_points_twoLine(p0,p1,q0,q1)
        if np.linalg.norm(pc-qc)*12 > 0.100:
